...
SNARKPROBE_DIR = Path(__file__).resolve().parent / "SNARKProbe"


def execute(bug_path: str):
    logging.debug(f"SNARKPROBE_DIR='{SNARKPROBE_DIR}'")
    ...
    # Change to the SNARKProbe directory
    os.chdir(SNARKPROBE_DIR)
